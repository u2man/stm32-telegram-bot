...
static const Keyboard::Key keyArray[30] =
{
	...
	{30, Rect(62, 193, 192, 40), BITMAP_KEYBOARD_SPACE_HIGHLIGHTED_ID}
};
...
static Keyboard::CallbackArea callbackAreas[4] =
{
    ...
    {Rect(5, 193, 56, 40), 0, BITMAP_KEYBOARD_KEY_NUM_HIGHLIGHTED_ID},
	{Rect(258, 193, 56, 40), 0, BITMAP_KEYBOARD_KEY_ENTER_HIGHLIGHTED_ID},// mode
};
