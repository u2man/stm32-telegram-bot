    ...
    firstCharacterEntry(false)
{
    ...
    modeBtnTextArea.setPosition(14, 196, 56, 40);
...
void CustomKeyboard::setBuffer(Unicode::UnicodeChar* thebuffer){

	Unicode::strncpy(buffer, thebuffer, BUFFER_SIZE);
	keyboard.setBufferPosition(Unicode::strlen(thebuffer));
