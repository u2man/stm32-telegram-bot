...
extern void Telegram_Task(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Telegramask */
  osThreadDef(Telegramask, Telegram_Task, osPriorityNormal, 0, 1024);
  TelegramaskHandle = osThreadCreate(osThread(Telegramask), NULL);
